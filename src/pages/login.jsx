        ...
        <div className="w-full h-full bg-[url('/background.jpg')] bg-cover bg-no-repeat bg-center flex">
           ...
           <div className="w-full lg:w-[50%] h-full flex justify-center items-center">
                ...
                <div className="w-112.5 h-150 backdrop-blur-3xl shadow-2xl rounded-lg flex flex-col justify-center m-2">
                    ...
                    <h1 className="text-2xl font-semibold text-white lg:hidden pl-35">Isuri Computers</h1>
                    <input 
                        type="email" 
                        placeholder="Email"
                        onChange={
                    ...
                    <button onClick={googleLogin} className="m-5 p-3 w-[90%] h-12.5 rounded-lg border border-accent text-white font-bold">Login with Google</button>
